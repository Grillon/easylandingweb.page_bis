...
import { Facebook, Instagram, Twitter, Youtube, Linkedin, Globe, Github } from 'lucide-react';
...
interface PortfolioSocialMediaBannerProps {
  socials: SocialMedia[];
...
export function PortfolioSocialMediaBanner({ socials, onChange }: PortfolioSocialMediaBannerProps) {
